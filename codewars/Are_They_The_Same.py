...
def comp(array1, array2):
    if array1 is None or array2 is None or not array1 or not array2:
        return False
    array1 = sorted(array1, key=lambda x: abs(x))
    array2 = sorted(array2, key=lambda x: abs(x))
    answer = [a1 * a1 == a2 for a1, a2 in zip(array1, array2)]
    return False if False in answer else True
